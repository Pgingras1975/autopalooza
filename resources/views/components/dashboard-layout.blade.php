...
<body>
    ...
    <script src="css/dashboard/assets/plugins/jquery-1.10.2.js"></script>
    <script src="css/dashboard/assets/plugins/bootstrap/bootstrap.min.js"></script>
    <script src="css/dashboard/assets/plugins/metisMenu/jquery.metisMenu.js"></script>
    <script src="css/dashboard/assets/plugins/pace/pace.js"></script>
    <script src="css/dashboard/assets/scripts/siminta.js"></script>
    <!-- Page-Level Plugin Scripts-->
    <script src="css/dashboard/assets/plugins/morris/raphael-2.1.0.min.js"></script>
    <script src="css/dashboard/assets/plugins/morris/morris.js"></script>
    <script src="css/dashboard/assets/scripts/dashboard-demo.js"></script>
