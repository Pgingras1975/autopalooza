                ...
                <div class="col-lg-6">
                    <div class="panel panel-primary">
                        <div class="panel-heading entete header-h" style="background-color:#e71d36">
                            <p class="header-fs"><i class="fa fa-bar-chart-o fa-fw"></i>{{ $employe->nom_complet}} (modifier mot de passe)
                        ...
                        <div class="panel-body form-h">
                            <div class="container">
                                <form form action="{{ url('/employe/modifier/pwd/' . $employe->id ) }}" method="post">
                                    @csrf
                                    <div class="row">
                                        <div class="col-25">
